    ...
    <div class="m-emotion-item" :class="mode === 'single' ? 'single' : 'list'">
        <div class="u-emotion">
            <div class="u-img" @click="preview">
                <img class="u-pic u-emotion-pic waterfall-img" :src="showEmotion(emotion.url)" :alt="emotion.desc" :key="emotion.url" />
            </div>
        </div>
        <div class="u-meta">
            <i class="u-star" v-if="emotion.star"> <i class="el-icon-star-off"></i>精选 </i>
        ...
        <div class="u-user">
            ...
            <a class="u-user-name" :href="emotion.user_id | authorLink" target="_blank" v-if="emotion.user_id">{{ emotion | showUserName }}</a>
        ...
        <div class="u-op u-editor" v-if="isEditor">
            ...
            <span class="u-delete el-link el-link--primary is-underline" @click="handleDelete"> <i class="el-icon-delete"></i> 删除 </span>
            <a class="u-edit el-link el-link--primary is-underline" :href="editLink('emotion', emotion.id)"> <i class="el-icon-edit-outline"></i> 编辑 </a>
        </div>
